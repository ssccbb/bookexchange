...
public class RollingTextView extends View {
    ...
    private RollingTextViewAdapter mDataSetAdapter;

    //平缓过度Adapter
    private RollingTextViewAdapter mTempAdapter;
...
//            Log.d(TAG, "绘制第" + cursor + "个条目");
    ...
    /**
     * 会重置滚动距离胡数据，造成视觉突变，如果想要平滑过渡使用{@link RollingTextView#setDataSetAdapterQuiet(RollingTextViewAdapter)} (RollingTextViewAdapter)}
     *
     * @param adapter 新的Adapter
     */
    public void setDataSetAdapter(RollingTextViewAdapter adapter) {
     ...
     * @param adapter 新的Adapter
     */
    public void setDataSetAdapterQuiet(RollingTextViewAdapter adapter) {
    ...
    public interface OnItemClickListener {
        void onItemClick(RollingTextView view, int index);
    }
